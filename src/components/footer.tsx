...
export default function Footer({ }) {
    return <footer className="bg-primary text-dark">
        <div className="font-martel grid lg:grid-cols-10 container py-10 px-10 space-y-4 lg:space-y-0">
            <div className="text-center lg:text-left lg:col-span-4 lg:mr-20 space-y-4">
                ...
                <div className="flex justify-center lg:justify-start gap-8 child:w-12 child:border-secondary child:border child:p-2 child:rounded-full pt-10 child:fill-secondary">
        ...
        <div className="border-t-2 border-[#B2A4A4] text-center font-martel py-2">
            ...
            <p className="font-extralight opacity-70">created by <a className="font-bold" target="_blank" href="https://muhammed-ali.vercel.app/">Muhammed alali</a></p>
        </div>
    </footer>
}