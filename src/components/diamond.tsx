export default function Diamond({ }) {
    return <section className="bg-primary text-center container space-y-10 py-20">
        <h4 className="text-header2 font-bastiken">A diamond is a woman`s best friends!</h4>
