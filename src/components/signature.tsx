...
export default function Signature({ }) {
    return <section className="flex flex-col container space-y-20 my-20 text-dark">
        ...
        <ul className="grid grid-cols-1 gap-10 lg:grid-cols-4 px-4 lg:px-0">
            <img loading="lazy" className="w-full" src="Rectangle 27.webp" />
            <img loading="lazy" className="w-full" src="Rectangle 28.webp" />
            <img loading="lazy" className="w-full" src="Rectangle 29.webp" />
            <img loading="lazy" className="w-full" src="Rectangle 30.webp" />
        </ul>
