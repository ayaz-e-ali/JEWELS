...
export default function Signature({ }) {
    return <section className="flex flex-col container space-y-20 my-20 ">
        ...
        <ul className="grid grid-cols-1 gap-10 lg:grid-cols-4 px-4 lg:px-0">
            <img className="w-full" src="Rectangle 27.png" />
            <img className="w-full" src="Rectangle 28.png" />
            <img className="w-full" src="Rectangle 29.png" />
            <img className="w-full" src="Rectangle 30.png" />
        </ul>
